...
docker run -v /tmp/xtdb1:/var/lib/xtdb \
    ...
    --env XTDB_SKIP_TXES='4993446721726062665' \
...
* Varying settings - what happens if we remove memory-swap, for example?
