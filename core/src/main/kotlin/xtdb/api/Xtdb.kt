...
import xtdb.api.metrics.OtelConfig
...
interface Xtdb : DataSource, AutoCloseable {
    ...
    data class Config(
        ...
        var otel: OtelConfig = OtelConfig(),
        ...
        fun otel(otel: OtelConfig) = apply { this.otel = otel }

        @JvmSynthetic
        fun otel(configure: OtelConfig.() -> Unit) = otel(OtelConfig().also(configure))
