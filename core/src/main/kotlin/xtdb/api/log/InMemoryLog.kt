...
class InMemoryLog(
    ...
    data class Factory(
        ...
        var epoch: Int = 0,
        @Transient var scope: CoroutineScope = CoroutineScope(Dispatchers.Default)
    ) : Log.Factory {
        ...
        override fun openLog(clusters: Map<LogClusterAlias, Cluster>) = InMemoryLog(instantSource, epoch, scope)
